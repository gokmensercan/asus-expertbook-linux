...
/*
 * ASUS ExpertBook Ultra B9406CAA: DSTS(0x50021) always returns 0x550000, so the
 * keyboard backlight level can never be read back. Keep the driver's cached
 * value instead of overwriting it with zero on every sysfs read.
 */
